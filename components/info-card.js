...
const InfoCard = ({ icon, sellYourHome, propWidth, propTextDecoration }) => {
    ...
    >
      <div className="flex flex-col items-start justify-start gap-[24px]">
        ...
        <div className="flex flex-col items-start justify-start gap-[24px]">
          ...
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] relative text-base leading-[24px] font-body-large-400 text-primary-500 text-left inline-block hover:[text-decoration:underline]"
            style={readMoreStyle}
          >
            Read more
          </button>
